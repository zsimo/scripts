...
if (!is_resource($socket)) {
	exit('Connessione fallita: '.$errnum.' ' .$errstr);
      ...
      // lasciando la stringa cos' sembra funzionare (anche con gli spazi)
      // se no prova con $input=”nome_var=”.htmlentities(rawurlencode(“Contenuto non accettabile nell’url”))
      // oppure direttamente urlencode()
	  $bodyRequest = "var1=data inviati from request body";
	  ...
	  $headers.="Content-Length: ".strlen($bodyRequest).$br ;
